...
app = Flask(__name__)
CORS(app)  # Replace "*" with your Netlify URL for more security
...
file_path = "C:/Users/Preesha Sheth/Desktop/ml/proj2/proj2/Dataset/training.csv"
...
def predict():
    ...
    # Convert input_features to a DataFrame with column names
    input_features_df = pd.DataFrame([input_features], columns=l1)
    ...
    predicted_disease_index = model.predict(input_features_df)[0]
